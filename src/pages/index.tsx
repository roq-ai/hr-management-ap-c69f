...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`HR Management Application v2`}</title>

        <meta
          name="description"
          content="Welcome to HR Management Application v2 - Your comprehensive solution for streamlining human resources tasks, optimizing productivity, and fostering a better workplace environment."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`HR Management Application v2`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application v2 - Your comprehensive solution for streamlining human resources tasks, optimizing productivity, and fostering a better workplace environment.`}
            </Text>
            <Box
