    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="established_at" mb="4">
            <FormLabel fontSize="1rem" fontWeight={600}>
              Established At
            </FormLabel>
            <DatePicker
              selected={formik.values?.established_at ? new Date(formik.values?.established_at) : null}
              onChange={(value: Date) => formik.setFieldValue('established_at', value)}
            />
          </FormControl>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'company_size',
              isInvalid: !!formik.errors?.company_size,
            }}
            name="company_size"
            error={formik.errors?.company_size}
            value={formik.values?.company_size}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('company_size', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
