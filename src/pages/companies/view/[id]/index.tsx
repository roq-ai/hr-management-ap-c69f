            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              ...
              >
                ...
                <FormListItem
                  ...
                  text={
                    data?.established_at
                      ? format(parseISO(data?.established_at as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />

                <FormListItem label="Industry Type" text={data?.industry_type} />

                <FormListItem label="Company Size" text={data?.company_size} />
