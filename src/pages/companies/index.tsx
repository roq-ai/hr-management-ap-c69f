...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        ...
        order: params.order,
        searchTermKeys: ['description.contains', 'industry_type.contains', 'name.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'description', header: 'Description', accessorKey: 'description' },
    {
      ...
      accessorKey: 'established_at',
      cell: ({ row: { original: record } }: any) =>
        record?.established_at ? format(parseISO(record?.established_at as unknown as string), 'dd-MM-yyyy') : '',
    },
    { id: 'industry_type', header: 'Industry Type', accessorKey: 'industry_type' },
    { id: 'company_size', header: 'company_size', accessorKey: 'company_size' },
