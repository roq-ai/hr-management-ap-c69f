...
import { BenefitListPage } from 'pages/benefits';
import { PerformanceReviewListPage } from 'pages/performance-reviews';
import { TrainingListPage } from 'pages/trainings';
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Employee Number" text={data?.employee_number} />

                <FormListItem
                  label="Hire Date"
                  text={data?.hire_date ? format(parseISO(data?.hire_date as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Job Title" text={data?.job_title} />
