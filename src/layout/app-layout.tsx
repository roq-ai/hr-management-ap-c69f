...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Benefits', path: '/benefits', entity: 'benefit', service: AccessServiceEnum.PROJECT, icon: FiGift },
    {
      name: 'Employees',
      path: '/employees',
      entity: 'employee',
    ...
    { name: 'Trainings', path: '/trainings', entity: 'training', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
